...
const Footer = () => {
  ...
  return (
    <div className="bg-black_cus px-5 lg:px-[104px] pb-16 pt-16">
      <div className="flex gap-10 md:justify-between flex-col sm:flex-row flex-wrap lg:flex-nowrap flex-1">
        ...
        <div className="sm:max-w-[227px] w-full  text-tag_p flex order-first lg:order-last flex-col gap-4">
          ...
          <button className="border-[#46BFB2] border-[1px] rounded-md py-2">
            Sign Up
          </button>
        </div>
      </div>
      <div className="my-[75px] text-tag_p flex flex-col lg:flex-row">
