      ...
      <div className="pl-[104px] pr-[235px]">
        ...
        <div className="flex gap-[54px] mb-8">
          ...
          <div className="text-base font-medium text-[#3A3B40] w-[695px]">
            <p className="mb-4">
              ...
              https://www.jademediapro.com website as well as any other media
              ...
              We are registered in Nigeria and have our registered office at 16
              Agbor street, Lagos. LA 100261. You agree that by accessing the
          ...
          <div className="text-base font-medium text-[#3A3B40] w-[695px]">
            ...
            <ul className="list-disc">
              ...
              <li>
                ...
                Internet browser usage,se, launch, develop, or distribute any
        ...
        <div className="flex gap-[54px] mb-8">
          ...
          <div className="text-base font-medium text-[#3A3B40] w-[695px]">
            <p className="mb-4">
              ...
              Policy: http://wwwjademediapro.com/privacy-policy. By using the
        ...
        <div className="flex gap-[54px] mb-8">
          ...
          <div className="text-base font-medium text-[#3A3B40] w-[695px]">
            ...
            <p className="mb-4">
              ...
              number of arbitrators shall be four (4). The seat, or legal place,
              of arbitration shall be Lagos, Nigeria. The language of the
              proceedings shall be English. The governing law of the contract
              shall be the substantive law of Nigeria.
            </p>
            <span className="text-[#77459B] text-lg font-medium mb-2">
              Restrictions
            </span>
        ...
        <div className="flex gap-[54px] mb-8">
          ...
          <div className="text-base font-medium text-[#3A3B40] w-[695px]">
            <p className="mb-4">
              ...
              the right, at your expense, to assume the exclusive defence and
        ...
        <div className="flex gap-[54px] mb-8">
          ...
          <div className="text-base font-medium text-[#3A3B40] w-[695px]">
            ...
            <p className="mb-4">
              1625 North Market Blvd., <br /> Suite N 112 <br />
              Sacramento, California 95834 <br /> or by telephone at (800)
