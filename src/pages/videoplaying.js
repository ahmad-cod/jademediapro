    ...
    <div className="px-6 md:px-16">
      <div className=" max-w-[865px]">
        ...
        <p>
          ...
          brand? A constant pull of value and inspiration. At this stage, we map
          out your customer’s journey so you’ll be able to meet them at their
          point of need before one of your competitors does. We partner with
          brands to take communication.
        </p>
      </div>
      <div>
