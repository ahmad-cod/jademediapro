              ...
              {caseStudy.contents?.map((first) => (
                <>
                  {first.firstSection?.map((first) => (
                    <>
                      <div className={styles.case_study_challenge_analysis}>
        ...
        <div className={styles.contributors}>
          <div className={styles.collaborators}>
            ...
            <div className={styles.collab_details}>
              <h2>CREATIVES</h2>
              <p>
                Yohanes Fadillah (Project Manager), Dino Martin (Brand Manager),
                Meg Tsuruda (Branding Coordinator), Jon Baumgardner (Director of
                Entertainment)
              </p>
            </div>
            <div className={styles.collab_details}>
